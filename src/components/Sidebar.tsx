...
import { FaHome, FaInfoCircle, FaEnvelope, FaWpforms, FaQuestionCircle, FaLayerGroup, FaSearch, FaChevronRight, FaBoxes, FaTags, FaShoppingCart, FaShoppingBag } from 'react-icons/fa';
